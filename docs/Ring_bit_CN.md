...
![](https://i.imgur.com/fMOf2AN.png)

#### G-V-S P2 connector 接口

只有当开关拨动到P2端，以下2个连接器才可以使用。可与部分八爪鱼扩展板兼容。

![](https://i.imgur.com/A88Nuff.png)

#### G-V-S SR/SL Connector 接口

只有当开关拨动到S端，以下2个连接器才可以使用。可与部分八爪鱼扩展板兼容。

![](https://i.imgur.com/4rhdleo.png)

#### 代码示例

迷你小象车巡线电路

![](https://i.imgur.com/vglmizE.png)

安装micro:bit主板

![](https://i.imgur.com/YVe6tRc.png)

#### G-V-S P0 Connector 接口

P0接口可作为数码IO口使用，模拟IO口或PWM输出信号。

![](https://i.imgur.com/aBCvSfZ.png)

### 参数

![](https://i.imgur.com/bsWtEid.png)

## 软件

组装micro:bit主板和舵机

![](https://i.imgur.com/C250Lyj.png)

![](https://i.imgur.com/6Cvdniy.png)
