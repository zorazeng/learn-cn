...
Robit是基于micro:bit的一个智能小车主板，它能完全兼容MBOT，除了继承了MBOT上简单方便的RJ25接线端口、电机接口和传感器之外，我们还扩展2路直流电机接口、两路步进电机口（步进电机接口与4路直流电机接口复用），8路PWM信号输出接口，可以驱动舵机等PWM信号驱动的设备，板载8路G-5V-S数字信号OCTOPUS电子积木接口，4路G-5V-S模拟信号OCTOPUS电子积木接口。Robit可以完成MBOT现有的基本的功能，它还可以扩展更多的传感器、电机、舵机、步进电机等功能，而且它的编程更加简单，它可以说的上是以micro:bit为主控的MBOT的升级版。
...
- 完全兼容MBOT的车架与传感器，并在MBOT基础上扩展了更多的功能。
- 支持4路直流电机驱动，2路步进电机驱动。
- 8路PWM信号输出接口。
