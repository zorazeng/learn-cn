...
Robit是基于micro:bit的一个智能小车主板，它能完全兼容MBOT，除了继承了MBOT上简单方便的RJ25接线端口、电机接口和传感器之外，我们还扩展4路直流电机接口、2路步进电机口（步进电机接口与直流电机接口复用），8路PWM信号输出接口，可以驱动舵机等PWM信号驱动的设备，板载10路G-5V-S数字信号OCTOPUS电子积木接口，4路G-5V-S模拟信号OCTOPUS电子积木接口。Robit除了可以所有MBOT的基本功能，还可以扩展更多的传感器、电机、舵机、步进电机等。
